...
public class MyCustomPasswordEncoder implements PasswordEncoder{
	private static Random saltSource = new SecureRandom();
	/**
	 ...
	 */
	private static String saltDelim = ":";
	 ...
	 */
	private static boolean checkLegacy(String password, String encrypted) {
	 ...
	 */
	private static boolean checkPbkdf2(String password, String encrypted) {
		String expectedHash;
	...
	public static String encrypt(String password) {
		...
		//byte[] salt = "v3vOsqq9lX+y1HdDiZOOnA==".getBytes();
	...
	public static String oldEncrpt(String password) {
	 ...
	 *
	 * @param length The number of bytes to use for
	 *  the source.
	...
	public boolean matches(CharSequence rawPassword, String encodedPassword) {
		...
		return check( (String) rawPassword, encodedPassword);
	}
}
